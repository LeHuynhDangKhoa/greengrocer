                ...
                >
                  <form onSubmit={handleSubmitProduct(handleAddProduct)}>
                    ...
                    <DialogContent style={{ paddingTop: 0, paddingBottom: 0 }}>
                      ...
                      <Controller
                        render={({ field }) => (
                          <Box style={{ marginTop: "15px", display: "flex", justifyContent: "center", alignItems: "center" }}>
                            <Rating
                      ...
                      <Box style={{ marginTop: "15px" }}>
                        <Typography style={{ fontWeight: "bold", color: "#9e9e9e", fontSize: "12px" }}>
                          Description
                        </Typography>
                        <Controller
                          render={({ field }) => (
                      ...
                      <Grid container>
                        <Grid item xs={12} sm={6}>
                          <Controller
                            render={({ field }) => (
                              <StyledHookFormControl fullWidth style={{ marginTop: "15px", width: "95%" }}>
                                <InputLabel id="categories" style={{ fontWeight: "bold" }}>
                                  Categories
                                </InputLabel>
                                <Select
                                  labelId="categories"
